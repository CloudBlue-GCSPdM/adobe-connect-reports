        ...
        for item in request['asset']['items']:
            if (get_basic_value(item, 'item_type') == 'PPU'
                ...
                yield (
                    ...
                    get_basic_value(item, 'display_name'),  # Product Description
                    get_basic_value(item, 'mpn'),  # Part Number
                    get_basic_value(item, 'period'),  # Product Period
                    get_basic_value(item, 'quantity'),  # Cumulative Seat
